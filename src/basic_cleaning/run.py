...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_artifact", 
        type = str,
        help = "The name of the input artifact containing the raw dataset",
        required = True
    )
    ...
    parser.add_argument(
        "--output_type", 
        type = str,
        help = "The type for th output artifact (e.g., 'clean_data'",
        required = True
    )
    ...
    parser.add_argument(
        "--min_price", 
        type = float,
        help = "The minimum price to consider when filtering listings",
        required = True
    )
    ...
    parser.add_argument(
        "--max_price",
        type = float,
        help = "The maximum price to consider when filtering listings",
        required = True
    )
